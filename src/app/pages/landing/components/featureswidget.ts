...
@Component({
    ...
    template: `<div id="features" class="pt-8" style="background-color: #000">
        <div class="flex flex-col items-center gap-4">
            ...
            <span class="text-white text-2xl uppercase">Soluciones integrales de transporte.</span>
            <h1 class="m-0 text-6xl" style="background: linear-gradient(110.43deg, #868cd0 0.04%, #ff5759 100.11%); background-clip: text; -webkit-background-clip: text; color: transparent">GST TRANSPORTES</h1>
        </div>
