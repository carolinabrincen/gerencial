...
@Component({
    ...
    template: `<div class="hidden lg:block absolute top-0 right-0 bottom-0 left-0 parallax__layer__0">
            <img [attr.draggable]="false" src="/demo/images/landing/layer-0-opt.jpg" class="w-full h-full block absolute bottom-0" />
        </div>
        <div class="hidden lg:block absolute top-0 right-0 bottom-0 left-0 parallax__layer__1">
            <img [attr.draggable]="false" src="/demo/images/landing/layer-1-opt.png" class="w-full block absolute bottom-0" />
        </div>
        ...
        <div class="hidden lg:flex absolute right-0 bottom-0 left-0 parallax__layer__3 justify-center" style="top: 27%">
            <div>
                ...
                <div class="flex -mt-6 justify-end">
                    <h1 class="m-0 text-white text-4xl">GST TRANSPORTES</h1>
                </div>
            </div>
        </div>
        <div class="hidden lg:block absolute top-0 right-0 bottom-0 left-0 parallax__layer__2">
            <img [attr.draggable]="false" src="/demo/images/landing/layer-2-opt.png" class="w-full block absolute bottom-0" />
        </div>
        ...
        <div class="block lg:hidden h-112 bg-center bg-no-repeat bg-cover" style="top: 68px; background: url(/demo/images/landing/landing-hero-image.jpg)">
            <div class="flex justify-center items-center h-full">
                <div class="flex flex-col">
                    ...
                    <div class="flex justify-end">
                        <span class="m-0 text-white text-sm font-semibold">GST TRANSPORTES</span>
                    </div>
