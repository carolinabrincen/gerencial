...
@Component({
    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-6">GST Transportes es una plataforma integral de gestión de transportes basada en Angular v21 con PrimeNG v21. Proporciona herramientas avanzadas para la administración de flotas y operaciones logísticas.</p>
            <pre class="app-code">
